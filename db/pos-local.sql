...
--
-- Host: 127.0.0.1
-- Generation Time: May 12, 2018 at 09:27 AM
...
(2, 'Dashboard', 'dashboard', 1, 'home', 'home', 0, 4),
(3, 'Modules', 'modules', 4, 'store', 'modules', 8, 4),
(5, 'Role/Permission', 'role', 2, 'verified_user', 'role', 8, 4),
(7, 'Users', 'user', 3, 'account_circle', 'users', 0, 2),
(8, 'Setting', 'setting', 2, 'settings', '#', 0, 2);
