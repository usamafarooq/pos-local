		...
		if ($f['filed_type'] == 'file') {
			...
			$contents .= '<td><?php echo %module["'.$f['name'].'"] ?></td>';
													...
													<td>
														...
														?>
														<a href="<?php echo base_url() ?>'.$controller_name.'/edit/<?php echo %module["id"] ?>"><img src="<?php echo base_url() ?>assets/icons/edit.png" title="Edit" alt="Edit" width="25" height="25"></a>
														<?php } ?>
														<?php 
															if (%permission["deleted"] == "1") {
														?>
		                                                <a href="<?php echo base_url() ?>'.$controller_name.'/delete/<?php echo %module["id"] ?>"><img src="<?php echo base_url() ?>assets/icons/delete.png" title="Delete" alt="Delete" width="25" height="25"></a>
		                                                <?php } ?>
	                                                </td>
	                                                <?php } ?>
												</tr>
